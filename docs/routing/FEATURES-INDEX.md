...
| **projects** | Project management | ProjectListPage (relay claim/release UI, Hub badges), ProjectSettings, WorktreeManager, ProjectEditDialog, GitStatusIndicator (branch name + clean/changed badge in project list) | `projects.*`, `git.status`, `relay.*` |
