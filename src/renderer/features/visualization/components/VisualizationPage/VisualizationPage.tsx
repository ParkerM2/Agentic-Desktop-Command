...
import { useVisualizationPage, useVisualizationPageParams } from './useVisualizationPage';
...
function VisualizationPageContent({ projectId }: { projectId: string }) {
  const {
    ...
    handleRefresh,
    isPending,
  } = useVisualizationPage(projectId);
...
export function VisualizationPage() {
  const { projectId } = useVisualizationPageParams();
