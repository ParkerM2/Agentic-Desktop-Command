...
import { useResultsToolbar } from './useResultsToolbar';
...
export function ResultsToolbar({
  ...
  const vm = useResultsToolbar({ copyText, runRecord });
  ...
  return (
    <Flex align="end" className="border-b border-border px-3 py-2" gap="sm" wrap="nowrap">
      ...
      {/* Copy button */}
      {activeRunId ? (
        <Button size="sm" variant="control" onClick={vm.handleCopy}>
          {vm.copied ? (
            <>
