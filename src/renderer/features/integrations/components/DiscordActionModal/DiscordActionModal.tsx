...
import { useDiscordActionModal } from './useDiscordActionModal';

import type { DiscordActionType } from './useDiscordActionModal';
...
export function DiscordActionModal({ actionType, onClose }: DiscordActionModalProps) {
  const { form, result, error, mcpCall, handleInputChange, handleStatusChange, handleSubmit } =
    useDiscordActionModal(actionType);
