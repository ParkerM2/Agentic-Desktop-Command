# component-engineer — Task Agent CLAUDE.md

> Auto-generated by `scripts/generate-worktree-claude.mjs`. Do not edit manually.
> Feature: `agent-dashboard-view` | Team: `agent-dashboard-phases-7-9` | Branch: `work/agent-dashboard-view/agent-dashboard-tasks-qa-ui`
...
You are **component-engineer** on team "agent-dashboard-phases-7-9".
Workbranch: `work/agent-dashboard-view/agent-dashboard-tasks-qa-ui`.
Working directory: `/Users/parker/Desktop/Agentic-Desktop-Command/.worktrees/agent-dashboard-view/agent-dashboard-tasks-qa-ui`.
Model: `sonnet` | MAX_THINKING_TOKENS: `4096`
...
**Slug**: `agent-dashboard-tasks-qa-ui`
**Wave**: 3
**Complexity**: high
...
## Agent Protocol — component-engineer
...
| This workbranch | `work/agent-dashboard-view/agent-dashboard-tasks-qa-ui` |
| Worktree | `/Users/parker/Desktop/Agentic-Desktop-Command/.worktrees/agent-dashboard-view/agent-dashboard-tasks-qa-ui` |
