...
import type { NotificationStore } from '@main/features/integrations/notifications/notification-store';
...
vi.mock('@main/features/integrations/notifications/notification-store', () => ({
...
vi.mock('@main/features/integrations/notifications/notification-filter', async () => {
  const actual = await import('@main/features/integrations/notifications/notification-filter');
  return actual;
});

const { createNotificationManager } = await import(
  '@main/features/integrations/notifications/notification-manager'
);

import type { NotificationManager, NotificationWatcher } from '@main/features/integrations/notifications/notification-manager';
